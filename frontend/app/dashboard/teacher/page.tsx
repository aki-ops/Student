...
import { CURRENT_USER_QUERY, GET_CLASSES_QUERY, GET_SCORES_QUERY, GET_ATTENDANCE_QUERY, GET_USERS_QUERY, FIND_USER_BY_ID_QUERY } from '@/graphql/queries';
    ...
    <div className="max-w-6xl mx-auto p-6 bg-gradient-to-br from-green-50 via-white to-blue-100 min-h-screen font-sans">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-2">
          <button
            className="px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition text-base font-semibold font-sans"
      ...
      <div className="bg-white/90 rounded-xl shadow-lg p-6 mb-8 border border-green-100">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-2">
          <h2 className="font-semibold text-2xl text-green-800 font-sans">🏫 Lớp học của tôi</h2>
          <button
      ...
      <div className="bg-white/90 rounded-xl shadow-lg p-6 mb-8 border border-green-100">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-2">
          <h2 className="font-semibold text-2xl text-green-800 font-sans">📊 Quản lý điểm</h2>
      ...
      <div className="bg-white/90 rounded-xl shadow-lg p-6 mb-8 border border-green-100">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-2">
          <h2 className="font-semibold text-2xl text-green-800 font-sans">📝 Quản lý điểm danh</h2>
          <div className="flex items-center gap-4">
            <input
              className="border-2 border-green-400 rounded-lg p-3 text-base text-gray-900 placeholder-gray-500 font-medium focus:ring-2 focus:ring-green-400 outline-none mb-2"
